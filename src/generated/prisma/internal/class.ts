...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchema": "generator client {\n  provider     = \"prisma-client\"\n  output       = \"../src/generated/prisma\"\n  moduleFormat = \"cjs\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n}\n\nmodel Link {\n  shortCode   String   @id @unique\n  originalUrl String\n  expireAt    DateTime @default(dbgenerated(\"(NOW() + '3 years'::interval)\"))\n\n  @@map(\"links\")\n}\n",
  "runtimeDataModel": {
    "models": {},
    "enums": {},
    "types": {}
...
config.runtimeDataModel = JSON.parse("{\"models\":{\"Link\":{\"fields\":[{\"name\":\"shortCode\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"originalUrl\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"expireAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"}],\"dbName\":\"links\"}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"Link.findUnique\",\"Link.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"Link.findFirst\",\"Link.findFirstOrThrow\",\"Link.findMany\",\"data\",\"Link.createOne\",\"Link.createMany\",\"Link.createManyAndReturn\",\"Link.updateOne\",\"Link.updateMany\",\"Link.updateManyAndReturn\",\"create\",\"update\",\"Link.upsertOne\",\"Link.deleteOne\",\"Link.deleteMany\",\"having\",\"_count\",\"_min\",\"_max\",\"Link.groupBy\",\"Link.aggregate\",\"AND\",\"OR\",\"NOT\",\"shortCode\",\"originalUrl\",\"expireAt\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"not\",\"contains\",\"startsWith\",\"endsWith\",\"set\"]"),
